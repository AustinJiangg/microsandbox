"""Stage 2b tests: a stateful REPL backed by a resident Jupyter kernel.
...
earlier variables remain" -- that last one best shows why 2b uses interrupt
...
def test_timeout_interrupts_but_kernel_survives(kernel_sandbox: Sandbox) -> None:
    ...
    """
    kernel_sandbox.run_code("keep = 'alive'")          # first define a variable
    ...
    kernel_sandbox.timeout_seconds = 30                # restore the normal timeout
