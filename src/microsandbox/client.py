...
see docs/STAGE3_DESIGN.md §6/§7 and scripts/build-rootfs.sh.
...
# repo's vendor/ (see docs/STAGE3_DESIGN.md §6/§7).
...
class Sandbox:
    ...
    Args:
        ...
        from_snapshot: if True, restore from a pre-warmed snapshot in milliseconds
            ...
            (the snapshot's vsock uds path is fixed, see docs/STAGE3_DESIGN.md §9).
